...
//         GuitarPlayer player = new GuitarPlayer(new java.io.File("./passenger-let_her_go.mid"));
//		DrumPlayer player = new DrumPlayer(new java.io.File("./we_wish_you_a_merry_christmas.mid"));
		GuitarPlayer player = new GuitarPlayer(new java.io.File("./we_wish_you_a_merry_christmas.mid"));
		player.play();
	}
